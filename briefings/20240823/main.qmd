...
## Summary
- For the upcoming flight on Sunday:
    - Moist margins are still uncertain: island of dry air along the EarthCare track
    - Precipitation and high clouds to the south of the island of dry air
    - Safe idea would be to place the circles and waypoints to the south of 10 deg
    - Doldrums also located close to 10 deg
- For future flights:
    - The arrival of a new easterly wave, makes the northern margin uncertain
