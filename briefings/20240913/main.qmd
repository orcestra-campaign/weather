...
## Summary
- Tomorrows's flight:
  - High likelihood to sample a well-defined ITCZ.
  - Likely to sample the doldrums on the norther circle.
  - Northern circle likely to be within the ITCZ. Yet, ITCZ moist margin is still uncertain.

- Monday's flight:
  - Still high uncertainty of moist margins due to TD Seven.
  - Souther moist margin better defined in latest forecasts.
