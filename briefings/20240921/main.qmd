...
## Summary
- Today's flight (PI Raphaela):
  - No significant deep convection expected

- Monday's flight (PI Theresa):
  - Certainly within the ITCZ moist margins, but outside the doldrums
  - Strong deep convection expected

- Tuesday's flight (PI Anna):
  - Same conditions as during Theresa's flight
  - Some chance to sample the same convective system as Theresa's flight
