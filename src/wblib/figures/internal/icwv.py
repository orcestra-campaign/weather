...
if __name__ == "__main__":
    ...
    briefing_time1 = pd.Timestamp(2024, 9, 23).tz_localize("UTC")
    current_time1 = pd.Timestamp(2024, 9, 23, 12).tz_localize("UTC")
    sattracks_fc_time1 = pd.Timestamp(2024, 9, 23).tz_localize("UTC")
    meteor_track = get_meteor_track(deduplicate_latlon=True)
    fig = iwv_itcz_edges(briefing_time1, "84H", current_time1,
