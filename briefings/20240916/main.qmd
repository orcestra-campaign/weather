...
## Summary
- Today's flight:
    - southern circle south west of the ITZC moist margin.
    - middle and norther circles inside the ITZC moist margins.
    - chance to sample the doldrums in inbound and outbound paths. 
    - might meet some convection during the flight, specially over the middle and norther circles.

- Thursday's flight:
    - southern ITCZ moist margin similar on latest operational runs but still uncertain on the ensemble.
    - likely to encounter convection associated with tropical depression Gordon.
