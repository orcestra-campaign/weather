...
if __name__ == "__main__":
    ...
    briefing_time1 = pd.Timestamp(2024, 8, 30).tz_localize("UTC")
    current_time1 = pd.Timestamp(2024, 8, 30, 10).tz_localize("UTC")
    sattracks_fc_time1 = pd.Timestamp(2024, 8, 29).tz_localize("UTC")
