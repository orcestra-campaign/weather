...
## Summary
- For today’s flight:
    - High cloud tops reaching about 15km in the centre circle & cloud circle
    - The width of the ITCZ (estimated based on moist margins) is narrower according to the latest forecast
    - Low wind regions in the cloud circle and the north circle

- For the upcoming flight on Wednesday:
    - Less uncertainty in the northern moist margins
    - Cloud top height ~ 12 km
