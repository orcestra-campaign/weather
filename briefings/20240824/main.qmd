...
## Summary
- Some problems with generating the briefing, we're sorry!
- Tomorrow's flight:
  - Southern circle should likely be adjusted, forecasts tend to converge on moist margin position
  - Chance to sample an interesting doldrum pattern
  - Convection should be rather calm
- Tuesday's flight:
  - Uncertainty in position of Northern moist margin due to tropical wave
  - Convection does not seem to be too deep