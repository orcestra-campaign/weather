...
if __name__ == "__main__":
    ...
    briefing_time1 = pd.Timestamp(2024, 9, 4).tz_localize("UTC")
    current_time1 = pd.Timestamp(2024, 9, 4, 12).tz_localize("UTC")
    sattracks_fc_time1 = pd.Timestamp(2024, 9, 4).tz_localize("UTC")
