...
- For tomorrow's flight:
    - all circles are forecasted to lie within the ITCZ
    - the two northern circles will likely sample the Doldrums
    - mostly shallow convection expected
- For next flight:    
    - southern edge of the ITCZ far south and close to land
    - position of northern edge of the ITCZ uncertain due to incoming tropical wave
