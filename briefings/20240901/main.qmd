...
##
### Exceptional precipitation over the Sahara
::: {layout-ncol=2}
![](fig/external_inst/precip_forecast_ecmwf.png){width=85%}

![](fig/external_inst/precip_forecast_ecmwf_anomaly.jpg){width=95%}
:::
...
## Summary
- Tuesday's flight:
  - Northern circle is not at the edge: Neither at moist margin nor at convection margin
  - Northern circle might sample a developing tropical strom though
  - Wide ITCZ with plenty of deep convection

- Transfer flight:
  - East and south of potentially developing tropical storm
  - Southern moist margin, which should be sampled, is rather certain

- Exceptional rain event in the Sahara expected