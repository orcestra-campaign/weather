...
## Summary
- For today's flight
    - ITCZ very wide, northern circle placed near the edge with strongest gradient
    - middle (and perhaps northern) circles prone to (strong) convective activity
    - ATR perhaps less convective, mid-level clouds
- For tomorrow's transfer flight    
    - more or less along the strongest southern IWV gradient, no threat of storms
