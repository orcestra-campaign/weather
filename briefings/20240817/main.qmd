...
## Zoom in at 15:15 UTC
![](fig/external_inst/screenshot_1515Z.png)
...
## Summary
- Tomorrow's flight:
  - Still some uncertainty in moist margins position
  - Strong convection expected during the flight, in particular on the northern edge
  - Chance to sample pronounced doldrums

- (Hopefully) Tuesday's flight:
  - Northern circle is hard to place, forecast still uncertain
  - Moderate deep convection expected in the ITCZ itself
  - High chance for notable rain on Sal