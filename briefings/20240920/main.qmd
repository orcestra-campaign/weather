...
## Summary
- Tomorrow's flight:
    - fligth inside the moist margins.
    - western circle on the moist margin.
    - likely to sample the doldrums north, along earthcare track.
    - no deep convection expected for the flight.
- Monday's flight:
  - fligth inside the moist margins.
  - potential for deep convection during the flight, specially on the two eastern circles.
