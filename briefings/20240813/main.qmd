...
## Summary
- Today's flight:
    - Latest satellite image confirms the forecast that no significant deep convection is expected during the flight
    - Some last changes in the edge positions
- Friday's flight:
    - Ahead of a new strong African easterly wave
    - Some uncertainty on how fast the wave will approach us
    - Currently it looks like pronounced deep convection will be present
