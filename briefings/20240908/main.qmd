...
## Summary
- Tomorrow's flight:
  - Northern circle should be placed a bit further north
  - Some uncertainty in northern moist margin position
  - Strong northern ITCZ edge with doldrums

- Next flight:
  - Very uncertain forecast of ITCZ moist margins
  - Uncertainty stemming from tropical wave/disturbance